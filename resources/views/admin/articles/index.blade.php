...
@section('content')
    ...
    <section class="content">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-actions">
                                            <button type="button" class="table-toggle" data-modal-open="article-edit-modal-{{ $article->id }}">
        ...
        @foreach ($articles as $article)
            <div
                id="article-edit-modal-{{ $article->id }}"
                class="admin-modal"
                data-admin-modal
                hidden
            >
                ...
                <div class="admin-modal-dialog">
                    <div class="admin-modal-header">
                        <div>
                            <h2 class="admin-modal-title">Sửa bài viết</h2>
                            <p class="admin-modal-subtitle">{{ $article->title }}</p>
                        </div>
